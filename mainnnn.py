...
['2', 'seconds', '5']
'''
# expr = input("Provide Input eg. 25 * 5 : ")
# # print("Expression entered is : "+expr)
# after_split = expr.split(" ")
#
# operation = after_split[1]
# num1 = int(after_split[0])
# num2 = int(after_split[2])
# print("Result : ")
# if operation == "+":
#     print(num1+num2)
# elif operation == "-":
...
# def arithmatic_operation(operation, num1, num2):
#     print("Result : ")
#     if operation == "+":
#         print(num1 + num2)
#     elif operation == "-":
...
# num1 = int(after_split[0])
# num2 = int(after_split[2])
# arithmatic_operation(operation, num1, num2)

''' CLASS WORK : '''

# A function which takes your name and prints it. Take the input from outside the function and pass it to the function.
...
#
#
# def calc(caller_variable):
#     print(myvariable)
#     # print(caller_variable)
#
#
# def caller():
#     caller_variable = 55
#     # calc(caller_variable)
#
# print(myvariable)
# # caller()
#
...
#     val = calc(55, 22)
#     print("From another function : " + str(val))
#
# def yet_another_function():
#     val = calc(77,11)
#     print("From Yet Another function : "+ str(val))
#
# giddy = calc(10, 22)
# print(giddy)
#
